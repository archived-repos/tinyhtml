...
describe('compact html', function () {
  ...
  it('compress Wikipedia', function () {
    ...
    assert.strictEqual( tinyHTML(snippetWikipedia.html, { ignore_unclosed: true }), snippetWikipedia.resultNoComments, 'compress');
    // assert.strictEqual( tinyHTML(snippetWikipedia.html, { ignore_unclosed: true, remove_comments: false }), snippetWikipedia.result, 'keep comments');
